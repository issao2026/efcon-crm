  ...
  const handleGenerate = async () => {
    ...
    try {
      const fields: Record<string, string> = {
        ...
        razaoSocialImobiliaria: form.corretorNome,
        cnpjImobiliaria: '12.345.678/0001-99',
        creciImobiliaria: form.corretorCreci,
        enderecoImobiliaria: 'Brasília, DF',
        foro_eleito: 'Brasília, DF',
